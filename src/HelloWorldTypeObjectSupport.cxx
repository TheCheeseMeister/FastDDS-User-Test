        ...
        TypeIdentifierPair& type_ids_HelloWorld)
{
    ...
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_HelloWorld)
    {
        ...
        }
        {
            ...
            ann_custom_HelloWorld.reset();
            CompleteMemberDetail detail_username = TypeObjectUtils::build_complete_member_detail(name_username, member_ann_builtin_username, ann_custom_HelloWorld);
            CompleteStructMember member_username = TypeObjectUtils::build_complete_struct_member(common_username, detail_username);
            TypeObjectUtils::add_complete_struct_member(member_seq_HelloWorld, member_username);
        }
        {
